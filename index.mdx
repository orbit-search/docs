...
<Steps>
  <Step title="Get an API key">
    Sign in to your Orbit account and create a developer API key with the scopes you need (`search:read`, `profile:read`).
  </Step>
  ...
  <Step title="Build your integration">
    Add your own data with Search Directories, scope searches to teams, and manage access with organization API keys.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Organization Access" icon="building" href="/concepts/organizations">
    Manage teams, issue organization-scoped API keys, and control directory access with fine-grained grants.
  </Card>
</CardGroup>
