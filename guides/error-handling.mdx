...
<AccordionGroup>
  ...
  <Accordion title="Request validation errors">
    ...
    | `developer_deep_search_field_unsupported` | Deep Search received a top-level body field other than `email`, `linkedinUrl`, `partialProfile`, or `structuredIntent`. |
    | `developer_deep_search_input_required` | Deep Search did not receive `email`, `linkedinUrl`, or `structuredIntent`. |
    ...
    | `developer_deep_search_input_conflict` | Deep Search received direct profile seed(s) and `structuredIntent`; send one request shape. |
    | `developer_deep_search_partial_profile_invalid` | Deep Search received a non-boolean `partialProfile` value. |
    | `developer_deep_search_partial_profile_generation_only` | Deep Search received `partialProfile` without an email or LinkedIn generation seed. |
    ...
    const VALIDATION_ERRORS = new Set([
      ...
      "developer_deep_search_input_conflict",
  ...
  <Accordion title="Developer Deep Search errors">
    ...
    | HTTP | Code | Description |
    |------|------|-------------|
    | 400 | `developer_deep_search_field_unsupported` | The body includes a top-level field other than `email`, `linkedinUrl`, `partialProfile`, or `structuredIntent`. |
    | 400 | `developer_deep_search_input_required` | The body is missing `email`, `linkedinUrl`, or `structuredIntent`. |
    ...
    | 400 | `developer_deep_search_input_conflict` | The body includes both profile generation seed(s) and `structuredIntent`. |
    | 400 | `developer_deep_search_partial_profile_invalid` | `partialProfile` is present but is not a boolean. |
    | 400 | `developer_deep_search_partial_profile_generation_only` | `partialProfile` was sent without an email or LinkedIn generation seed. |
...
| Status | Codes |
|--------|-------|
| 400 | `developer_query_required`, `developer_num_users_required`, `developer_num_users_limit_exceeded`, `developer_user_id_override_forbidden`, `developer_search_replay_unsupported`, `structured_intent_required`, `structured_intent_invalid`, `structured_intent_version_unsupported`, `structured_intent_entity_clauses_unsupported`, `structured_intent_server_owned_field`, `search_directory_cross_org_scope_unsupported`, `developer_deep_search_field_unsupported`, `developer_deep_search_input_required`, `developer_deep_search_email_invalid`, `developer_deep_search_linkedin_invalid`, `developer_deep_search_input_conflict`, `developer_deep_search_name_required`, `developer_deep_search_arbitrary_input_required`, `developer_deep_search_personalization_unsupported` |
| 401 | `missing_api_key` |
