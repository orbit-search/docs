...
<AccordionGroup>
  ...
  <Accordion title="Request validation errors">
    ...
    | `developer_deep_search_field_unsupported` | Deep Search received a top-level body field other than `email`, `linkedinUrl`, or `structuredIntent`. |
  ...
  <Accordion title="Developer Deep Search errors">
    ...
    | HTTP | Code | Description |
    |------|------|-------------|
    | 400 | `developer_deep_search_field_unsupported` | The body includes a top-level field other than `email`, `linkedinUrl`, or `structuredIntent`. |
