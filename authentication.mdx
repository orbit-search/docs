...
|---|---|
| `search:read` | Call search endpoints, including Search (`POST /v2/developer/search`, `POST /v2/developer/search/sse`) and Developer Deep Search (`POST /v2/developer/deep-search`) |
