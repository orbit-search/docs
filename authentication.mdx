...
|---|---|
| `search:read` | Call search endpoints, including smart search (`POST /v2/social/profiles/searches/smart`) and Developer Deep Search (`POST /v2/developer/deep-search`) |
